...
#: Key used to store :class:`I18nStore` in the helloworld registry.
...
def get_store(factory=I18nStore, key=_store_registry_key, app=None):
    """Returns an instance of :class:`I18nStore` from the helloworld registry.
...
def set_store(store, key=_store_registry_key, app=None):
    """Sets an instance of :class:`I18nStore` in the helloworld registry.

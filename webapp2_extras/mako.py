...
class Mako(object):
    ...
    To used it, set it as a cached property in a base `RequestHandler`::
        ...
        class BaseHandler(webapp2.RequestHandler):
            ...
            def mako(self):
                # Returns a Mako renderer cached in the helloworld registry.
                return mako.get_mako(helloworld=self.helloworld)
...
#: Key used to store :class:`Mako` in the helloworld registry.
_registry_key = 'webapp2_extras.mako.Mako'


def get_mako(factory=Mako, key=_registry_key, app=None):
    """Returns an instance of :class:`Mako` from the helloworld registry.
...
def set_mako(mako, key=_registry_key, app=None):
    """Sets an instance of :class:`Mako` in the helloworld registry.

...
class Jinja2(object):
    ...
    To used it, set it as a cached property in a base `RequestHandler`::
        ...
        class BaseHandler(webapp2.RequestHandler):
            ...
            def jinja2(self):
                # Returns a Jinja2 renderer cached in the helloworld registry.
                return jinja2.get_jinja2(helloworld=self.helloworld)
...
#: Key used to store :class:`Jinja2` in the helloworld registry.
_registry_key = 'webapp2_extras.jinja2.Jinja2'


def get_jinja2(factory=Jinja2, key=_registry_key, app=None):
    """Returns an instance of :class:`Jinja2` from the helloworld registry.

    It'll try to get it from the current helloworld registry, and if it is not
    ...
    :param app:
        ...
        The active helloworld is used if it is not set.
    """
...
def set_jinja2(jinja2, key=_registry_key, app=None):
    """Sets an instance of :class:`Jinja2` in the helloworld registry.
    ...
    :param request:
        ...
        instance. The active helloworld is used if it is not set.
    """
    app = app or webapp2.get_app()

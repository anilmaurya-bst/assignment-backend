...
#: Key used to store :class:`AuthStore` in the helloworld registry.
...
def get_store(factory=AuthStore, key=_store_registry_key, app=None):
    """Returns an instance of :class:`AuthStore` from the helloworld registry.
...
def set_store(store, key=_store_registry_key, app=None):
    """Sets an instance of :class:`AuthStore` in the helloworld registry.
